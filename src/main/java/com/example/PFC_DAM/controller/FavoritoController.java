...
public class FavoritoController {
    ...
    public String eliminarFavoritos(@PathVariable Long animalId, @RequestParam(required = false) String origen, Model model, Principal principal, RedirectAttributes redirectAttributes) {
        Cuenta cuenta = cuentaRepository.findByEmail(principal.getName()).orElseThrow();
        Adoptante adoptante = adoptanteRepository.findByCuenta(cuenta).orElseThrow();

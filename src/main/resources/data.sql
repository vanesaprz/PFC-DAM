...
TRUNCATE TABLE animales CASCADE;
TRUNCATE TABLE protectoras CASCADE;

-- 2. Insertar Protectora
INSERT INTO protectoras (id, nombre, email_contacto, telefono, direccion, provincia)
VALUES (1, 'Huellas Felices', 'info@huellas.org', '600111222', 'Calle Principal 1', 'Pontevedra');
...
VALUES ('Rocco', 'Perro', 'Mastín Español', 'MACHO', '2017-04-12', '2024-01-20', 'URGENTE',
       ...
       ('Cloe', 'Gato', 'Persa', 'HEMBRA', '2019-09-30', '2024-03-25', 'URGENTE',
        ...
        'No', 'No', 'Sí', NULL, 'Cloe es una gata de hogar que fue abandonada por fallecimiento de su dueño.', 1);
...
VALUES ('Zas', 'Perro', 'Border Collie', 'MACHO', '2022-08-10', '2024-04-18', 'DISPONIBLE',
        ...
        true, true, true, true, NULL, 'Muy Alto',
        'Sí', 'Sí', 'Sí', NULL, 'El más reciente en llegar. Inteligente, ágil y listo para aprender trucos.', 1),
       ('Mora', 'Gato', 'Europeo Negro', 'HEMBRA', '2023-12-15', '2024-04-15', 'DISPONIBLE',
        ...
        'Sí', 'Sí', 'Sí', NULL, 'Cachorrita juguetona rescatada de un motor de coche.', 1),
       ('Balto', 'Perro', 'Husky Siberiano', 'MACHO', '2020-02-28', '2024-04-10', 'DISPONIBLE',
        ...
        'Sí', 'No', 'No', 'Calor excesivo', 'Un perro precioso que necesita largos paseos por el monte.', 1),
       ('Kira', 'Perro', 'Galgo', 'HEMBRA', '2021-05-22', '2024-04-05', 'DISPONIBLE',
        ...
        'Sí', 'No', 'Sí', 'Coches', 'Elegante y silenciosa. Le encanta dormir en camas acolchadas.', 1),
       ('Pipo', 'Perro', 'Beagle', 'MACHO', '2023-01-14', '2024-03-28', 'DISPONIBLE',
        ...
        'Sí', 'Sí', 'Sí', NULL, 'Rastreador incansable. Siempre tiene la nariz pegada al suelo.', 1),
       ('Sombra', 'Gato', 'Azul Ruso Mix', 'HEMBRA', '2021-10-10', '2024-03-20', 'DISPONIBLE',
        ...
        'No', 'No', 'No', 'Extraños', 'Sombra busca una persona tranquila, es algo desconfiada al inicio.', 1);
...
VALUES ('Lucky', 'Perro', 'Labrador', 'MACHO', '2018-03-10', '2023-11-10', 'ADOPTADO',
        ...
        true, true, true, true, NULL, 'Medio',
        'Sí', 'Sí', 'Sí', NULL, 'Lucky ya vive feliz con su nueva familia en el campo.', 1);
